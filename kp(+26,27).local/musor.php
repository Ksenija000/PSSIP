...
<div class="card">
    <form method="POST" id="productForm">
        ...
        <div style="display: grid; grid-template-columns: repeat(2, 1fr); gap: 20px;">
            ...
            <div>
                ...
                <div style="margin-bottom: 15px;">
                    ...
                    <select name="artist_id" required style="width: 100%; padding: 12px; background: var(--admin-surface-light); border: 1px solid var(--admin-border); border-radius: 30px; color: var(--admin-text);">
                        ...
                        <option value="<?php echo $art['id']; ?>" <?php echo (isset($product) && $product['artist_id'] == $art['id']) ? 'selected' : ''; ?>>
                ...
                <div style="margin-bottom: 15px;">
                    ...
                    <input type="text" name="art_style" value="<?php echo htmlspecialchars($product['art_style'] ?? ''); ?>" 
                           style="width: 100%; padding: 12px; background: var(--admin-surface-light); border: 1px solid var(--admin-border); border-radius: 30px; color: var(--admin-text);">
                </div>
                
                <div style="margin-bottom: 15px;">
                    <label style="display: block; margin-bottom: 5px; color: var(--admin-text-secondary);">Год создания</label>
                    <input type="number" name="year_created" value="<?php echo $product['year_created'] ?? date('Y'); ?>" 
                           style="width: 100%; padding: 12px; background: var(--admin-surface-light); border: 1px solid var(--admin-border); border-radius: 30px; color: var(--admin-text);">
                </div>
            </div>
            ...
            <div>
                <div style="margin-bottom: 15px;">
                    ...
                    <input type="number" step="0.01" name="price" id="price" required value="<?php echo $product['price'] ?? 0; ?>" 
                           style="width: 100%; padding: 12px; background: var(--admin-surface-light); border: 1px solid var(--admin-border); border-radius: 30px; color: var(--admin-text);">
                </div>
                ...
                <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 10px; margin-bottom: 15px;">
                    <div>
                        ...
                        <input type="number" step="0.01" name="discount_percent" id="discount_percent" value="<?php echo $product['discount_percent'] ?? ''; ?>" 
                               style="width: 100%; padding: 12px; background: var(--admin-surface-light); border: 1px solid var(--admin-border); border-radius: 30px; color: var(--admin-text);">
                    </div>
                    <div>
                        <label style="display: block; margin-bottom: 5px; color: var(--admin-text-secondary);">Цена со скидкой</label>
                        <input type="number" step="0.01" name="discount_price" id="discount_price" value="<?php echo $product['discount_price'] ?? ''; ?>" 
                               style="width: 100%; padding: 12px; background: var(--admin-surface-light); border: 1px solid var(--admin-border); border-radius: 30px; color: var(--admin-text);">
                    </div>
                </div>
                ...
                <div style="margin-bottom: 15px;">
                    ...
                    <input type="number" step="0.01" name="weight_kg" value="<?php echo $product['weight_kg'] ?? 0; ?>" 
                           style="width: 100%; padding: 12px; background: var(--admin-surface-light); border: 1px solid var(--admin-border); border-radius: 30px; color: var(--admin-text);">
                </div>
        ...
        <div style="margin: 20px 0;">
            ...
            <textarea name="opisanie" rows="6" style="width: 100%; padding: 15px; background: var(--admin-surface-light); border: 1px solid var(--admin-border); border-radius: 15px; color: var(--admin-text);"><?php echo htmlspecialchars($product['opisanie'] ?? ''); ?></textarea>
        </div>
        
        <!-- Главное фото -->
        <div style="margin: 20px 0;">
            <label style="display: block; margin-bottom: 5px; color: var(--admin-text-secondary);">Главное фото (URL)</label>
            <input type="text" name="image" id="main_image" value="<?php echo htmlspecialchars($product['image'] ?? ''); ?>" 
                   style="width: 100%; padding: 12px; background: var(--admin-surface-light); border: 1px solid var(--admin-border); border-radius: 30px; color: var(--admin-text);">
