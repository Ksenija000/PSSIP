...
<head>
    ...
    <title>ARTOBJECT | Пользовательское соглашение</title>
    <style>
        /* ============================================ */
    ...
    <section class="page-header">
        <div class="container">
            <div class="page-header-content">
                <h1>Пользовательское <span class="text-gradient">соглашение</span></h1>
            </div>
        </div>
    </section>
    ...
    <section class="legal-section">
        <div class="container">
            <div class="legal-content">
                ...
                <p>1.1. Продавец – ARTOBJECT Gallery (интернет-магазин по адресу <a href="index.php">artobject.by</a>), являющееся владельцем товаров, представленных на Сайте.</p>
                <p>1.2. Покупатель – любое физическое или юридическое лицо, акцептировавшее публичную оферту на условиях настоящего Соглашения.</p>
                <p>1.3. Сайт – интернет-сайт, расположенный по адресу <a href="index.php">artobject.by</a>, где представлены Товары и предоставляются услуги по продаже Товаров.</p>
                <p>1.4. Товар – объект материального мира (произведение искусства, арт-объект), представленный к продаже на Сайте.</p>
                <p>1.5. Заказ – должным образом оформленный запрос Покупателя на приобретение и доставку Товаров по указанному Покупателем адресу.</p>

                <h2>2. Предмет соглашения</h2>
                <p>2.1. Продавец обязуется передать в собственность Покупателя, а Покупатель обязуется оплатить и принять заказанный им товар на условиях настоящего Соглашения.</p>
                <p>2.2. Настоящее Соглашение регулирует отношения между Продавцом и Покупателем по продаже и доставке Товаров через Сайт.</p>

                <h2>3. Оформление заказа</h2>
                <p>3.1. Заказ Покупателя оформляется через корзину на сайте <a href="index.php">artobject.by</a>.</p>
                <p>3.2. После оформления заказа Покупателю предоставляется информация о подтверждении заказа и сроках доставки.</p>
                <p>3.3. Продавец имеет право аннулировать Заказ Покупателя в случае отсутствия товара на складе по независящим от Продавца причинам.</p>
                <p>3.4. Все информационные материалы, представленные на Сайте, носят справочный характер и могут быть изменены Продавцом без уведомления Покупателя.</p>

                <h2>4. Оплата товара</h2>
                <p>4.1. Цена товара указывается на Сайте. В случае неверного указания цены Продавец информирует об этом Покупателя для подтверждения Заказа по исправленной цене либо аннулирования Заказа.</p>
                <p>4.2. Оплата товара производится способами, указанными на Сайте:</p>
                <ul>
                    <li>Банковской картой онлайн (Visa, Mastercard, МИР);</li>
                    <li>Наличными курьеру при получении;</li>
                    <li>Безналичный расчет для юридических лиц.</li>
                </ul>
                <p>4.3. Факт оплаты товара подтверждается электронным или кассовым чеком, который направляется Покупателю на электронную почту.</p>

                <h2>5. Доставка товара</h2>
                <p>5.1. Доставка товара осуществляется по всей территории Республики Беларусь.</p>
                <p>5.2. Стоимость доставки рассчитывается индивидуально и зависит от региона доставки и суммы заказа.</p>
                <p>5.3. При заказе на сумму от 500 BYN доставка осуществляется бесплатно.</p>
                <p>5.4. Сроки доставки составляют:</p>
                <ul>
                    <li>По Минску – 1-3 рабочих дня;</li>
                    <li>По Беларуси – 3-7 рабочих дней.</li>
                </ul>
                <p>5.5. Право собственности на Товар и риск его случайной гибели переходят к Покупателю с момента передачи ему Товара и проставления им подписи в документах, подтверждающих доставку.</p>

                <h2>6. Возврат товара</h2>
                <p>6.1. Покупатель вправе отказаться от товара надлежащего качества в течение 7 дней с момента получения товара, если товар не был в употреблении, сохранены его товарный вид, потребительские свойства, пломбы, фабричные ярлыки.</p>
                <p>6.2. Возврат товара надлежащего качества производится за счет Покупателя.</p>
                <p>6.3. Возврат денежных средств производится в течение 10 дней с момента получения возвращенного товара.</p>
                <p>6.4. При обнаружении недостатков товара Покупатель вправе предъявить требования, предусмотренные Законом Республики Беларусь «О защите прав потребителей».</p>

                <h2>7. Права и обязанности сторон</h2>
                <p>7.1. Продавец обязуется:</p>
                <ul>
                    <li>Передать Покупателю товар надлежащего качества;</li>
                    <li>Предоставить всю необходимую информацию о товаре;</li>
                    <li>Соблюдать конфиденциальность персональных данных Покупателя.</li>
                </ul>
                <p>7.2. Покупатель обязуется:</p>
                <ul>
                    <li>Оплатить и принять заказанный товар;</li>
                    <li>Предоставить достоверную информацию, необходимую для доставки товара;</li>
                    <li>Не использовать информацию, размещенную на Сайте, в коммерческих целях без согласия Продавца.</li>
                </ul>

                <h2>8. Ответственность сторон</h2>
                <p>8.1. За неисполнение или ненадлежащее исполнение условий настоящего Соглашения Стороны несут ответственность в соответствии с законодательством Республики Беларусь.</p>
                <p>8.2. Продавец не несет ответственности за задержки и недостатки при исполнении Заказа, возникшие по вине Покупателя или вследствие обстоятельств непреодолимой силы.</p>
                <p>8.3. Продавец не несет ответственности за содержание и достоверность информации, предоставленной Покупателем при оформлении Заказа.</p>

                <h2>9. Конфиденциальность и защита информации</h2>
                <p>9.1. При оформлении Заказа Покупатель предоставляет Продавцу свои персональные данные, которые обрабатываются в соответствии с <a href="privacy.php">Политикой конфиденциальности</a>.</p>
                <p>9.2. Продавец обязуется не разглашать полученную от Покупателя информацию. Не считается нарушением предоставление информации третьим лицам, действующим на основании договора с Продавцом для исполнения обязательств перед Покупателем.</p>

                <h2>10. Прочие условия</h2>
                <p>10.1. Настоящее Соглашение вступает в силу с момента акцепта Покупателем и действует до полного исполнения сторонами своих обязательств.</p>
                <p>10.2. Продавец вправе вносить изменения в настоящее Соглашение без уведомления Покупателя. Новая редакция Соглашения вступает в силу с момента ее размещения на Сайте.</p>
                <p>10.3. Признание судом какого-либо положения настоящего Соглашения недействительным не влечет недействительность остальных положений.</p>
                <p>10.4. Во всем остальном, что не предусмотрено настоящим Соглашением, стороны руководствуются действующим законодательством Республики Беларусь.</p>

                <h2>11. Реквизиты Продавца</h2>
                <p>ARTOBJECT Gallery</p>
                <p>Юридический адрес: г. Минск, ул. Искусств, 15</p>
                <p>УНП: 123456789</p>
                <p>Расчетный счет: BY00 1234 5678 9012 3456 7890 1234</p>
                <p>Банк: ОАО «Беларусбанк», г. Минск</p>
                <p>Email: info@artobject.by</p>
